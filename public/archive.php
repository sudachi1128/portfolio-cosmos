            ...
            <li class="archive__item">
              <a class="archive__link" href="<?php the_permalink(); ?>">
                <div class="archive__date-box">
                  <time class="archive__date-small" datetime="<?php the_time('Y-m-d'); ?>"><?php the_time(get_option('date_format')); ?></time>
                  <time class="archive__date-big" datetime="<?php the_time('Y-m-d'); ?>"><?php the_time('md'); ?></time>
                </div>
